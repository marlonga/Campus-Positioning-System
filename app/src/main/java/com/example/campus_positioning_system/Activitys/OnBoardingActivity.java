...
public class OnBoardingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listItems.add(new SlideModel(R.drawable.ob_2_navbar,"Navigationsleiste", "In der Navigationsleiste finden Sie verschiedene Kategorien der App. Dazu zählen: Favoriten, Schnellwahl, Raumwahl, Einstellungen und einen QR Code Scanner."));
